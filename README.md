...
To make the sources work, you need to download the branch archive I created and rename it to `jimedrand-4.3.1-pure-man-sources.vroid` using the commands below. But before that, you need to install `zip` and `wget` first on your Unix-like systems. 
```bash
